    ...
    <div className='container mx-auto max-w-md text-center font-mono'>
      ...
      <ul className='list-rest text-white p-0'>
        {state.todos.map(todo => (
                                                                                                              ...
                                                                                                              >
                                                                                                                <span className={`cursor-pointer flex-1 ml-12 ${todo.complete && "line-through text-gray-900"}`} onDoubleClick={() => dispatch({type: "TOGGLE_TODO", payload: todo})}>{todo.text}</span>
                                                                                                                <button>
                                                                                                                  <img
